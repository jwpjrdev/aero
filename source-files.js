...
sourcesIndex["aero_kernel"] = {"name":"","dirs":[{"name":"acpi","files":["aml.rs","fadt.rs","hpet.rs","madt.rs","mcfg.rs","mod.rs","rsdp.rs","sdt.rs"]},{"name":"arch","dirs":[{"name":"x86_64","dirs":[{"name":"interrupts","files":["exceptions.rs","idt.rs","mod.rs"]}],"files":["controlregs.rs","gdt.rs","mod.rs","signals.rs","syscall.rs","task.rs","tls.rs"]}],"files":["mod.rs"]},{"name":"drivers","dirs":[{"name":"block","dirs":[{"name":"ide","files":["channel.rs","mod.rs","registers.rs"]}],"files":["ahci.rs","mod.rs"]}],"files":["keyboard.rs","lai.rs","mod.rs","pci.rs","tty.rs","uart_16550.rs"]},{"name":"fs","files":["block.rs","cache.rs","devfs.rs","file_table.rs","initramfs.rs","inode.rs","mod.rs","pipe.rs","procfs.rs","ramfs.rs"]},{"name":"mem","dirs":[{"name":"paging","files":["addr.rs","frame.rs","mapper.rs","mod.rs","page.rs","page_table.rs"]}],"files":["alloc.rs","mod.rs","pti.rs","vmalloc.rs"]},{"name":"socket","files":["mod.rs","unix.rs"]},{"name":"syscall","files":["fs.rs","ipc.rs","mod.rs","net.rs","process.rs","time.rs"]},{"name":"userland","dirs":[{"name":"scheduler","files":["mod.rs","round_robin.rs"]}],"files":["mod.rs","signals.rs","task.rs","vm.rs"]},{"name":"utils","files":["bitmap.rs","buffer.rs","io.rs","linker.rs","mod.rs","sync.rs"]}],"files":["apic.rs","cmdline.rs","logger.rs","main.rs","modules.rs","rendy.rs","time.rs","unwind.rs"]};
